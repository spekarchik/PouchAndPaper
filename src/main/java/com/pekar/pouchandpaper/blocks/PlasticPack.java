...
//			"from": [1.25, 0, 2.75],
//                    "to": [14, 14.75, 14],
    private static final VoxelShape SHAPE_FULL3 = Shapes.create(0.078125, 0.0, 0.171875, 0.875, 0.921875, 0.875);
...
//			"from": [1.5, 0, 3],
//                    "to": [13.5, 9.5, 13.75],
    private static final VoxelShape SHAPE_SEMI3 = Shapes.create(0.09375, 0.0, 0.1875, 0.84375, 0.59375, 0.859375);
...
//			"from": [1.75, 0, 3.5],
//                    "to": [13.25, 3.5, 13.75],
    private static final VoxelShape SHAPE_EMPTY3 = Shapes.create(0.109375, 0.0, 0.21875, 0.828125, 0.21875, 0.859375);
    ...
    private static final VoxelShape COLLISION_FULL3 = Shapes.create(0.078125 + 0.125, 0.0, 0.171875 + 0.125, 0.875 - 0.125, 0.921875, 0.875 - 0.125);
    ...
    private static final VoxelShape COLLISION_SEMI3 = Shapes.create(0.09375 + 0.125, 0.0, 0.1875 + 0.125, 0.84375 - 0.125, 0.59375, 0.859375 - 0.125);
    ...
    private static final VoxelShape COLLISION_EMPTY3 = Shapes.create(0.109375 + 0.125, 0.0, 0.21875 + 0.125, 0.828125 - 0.125, 0.21875, 0.859375 - 0.125);
