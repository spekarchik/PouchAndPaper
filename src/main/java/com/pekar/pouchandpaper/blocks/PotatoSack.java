...
{
    public PotatoSack(Properties properties, FarmContainerConfiguration containerConfiguration)
    {
    ...
    {
        return BlockEntityRegistry.SACK_OF_POTATO_BLOCK_ENTITY.create(blockPos, blockState);
    }
}
